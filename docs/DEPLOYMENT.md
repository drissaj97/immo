...
|----------|--------|---------|
| `NEXT_PUBLIC_APP_URL` | ✓ | `https://samsar-ia.ma` |
...
```bash
# Health checks
curl -I https://samsar-ia.ma/fr
curl https://samsar-ia.ma/sitemap.xml
curl https://samsar-ia.ma/robots.txt
